...
void ATestTopDownCharacter::OnDmd_Implementation(float Dmg)
{
	HealthComponent->GetDmg(Dmg);
}

void ATestTopDownCharacter::OnHeal_Implementation(float Heal)
{
	HealthComponent->GetHeal(Heal);
}

void ATestTopDownCharacter::OnDeath_Implementation()
{
